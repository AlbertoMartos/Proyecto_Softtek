...
//	}
	...
	@PutMapping
	public ResponseEntity<PacienteDTO> modificar(@Valid @RequestBody Paciente p) throws Exception {
		...
		if (pacienteConsultado == null) {
			throw new ModeloNotFoundException("ID NO ENCONTRADO " + pacienteConsultado.getIdPaciente());
		}
